...
describe("Product page", () => {
  ...
  it("Add review to product (successful)", () => {
    ...
    //Assert
    singleProductPage.messageLabel.should(
      "have.text",
  ...
  it("Add review to product (unsuccessful) - Empty name", () => {
    ...
    //Act
    singleProductPage.addReview(emptyName, email, singleProductPage.review);
    singleProductPage.submitButton.click();

    //Assert
    singleProductPage.nameInput
  ...
  it("Add review to product (unsuccessful) - Empty review", () => {
    ...
    //Act
    singleProductPage.addReview(singleProductPage.name, email, emptyReview);
    singleProductPage.submitButton.click();

    //Assert
    singleProductPage.reiewInput
      .invoke("prop", "validationMessage")
      .should("equal", loginSignUp.valueMissingMessage);
  });
});
